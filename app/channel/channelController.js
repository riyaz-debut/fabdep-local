...
class ChannelController {
     ...
     */
     ...
     static async createChannel(data) {
        ...
        try {
            ...
            console.log("organization data :", organisation)
    ...
    static async joinChannel(data) {
        ...
        try {
             ...
             */
            // console.log("peerDetails :", peerDetails)
            const joinresult = configtx.joinChannelData(basePath, peers, orderernode, channelDetail.name);

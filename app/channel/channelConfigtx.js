...
function joinChannelData(channelBasePath, peers, orderernode, channelName) {
    console.log("i am in joinChannelData")
    console.log(channelBasePath);
    let status = 'initial';
    peers.forEach(peerDetails => {
...
async function fetchChannelPrereqsiteData(data) {
    console.log("in fetchChannelPreReqs Data :", data)
    console.log("in fetchChannelPreReqs Data :", data.channelId)

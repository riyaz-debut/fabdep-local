...
// // Returns the consfigtx with the multiNodeEtcdraft profile for the ordering service
function getOrganisations(organisations) {
  ...
  function getGenesisRaftTx(orderingList, ordererDetail) {
    ...
    for (let i = 0; i < orderingList.length; i++) {
      ...
      console.log("basePath ", basePath); //home/developer/Documents/network1/orderer-test-ca-root-test
    ...
    console.log(
      "firstOrdererbasePath in get genesisRaftTx:",
      firstOrdererbasePath
    );
    return {
      Profiles: {
        MultiNodeEtcdRaft: {
          ...
          Consortiums: {
            SampleConsortium: {
              Organizations: getOrganisationsWithoutAnchor(
...
// ========================================================================================================
// ======================== changes for common configtx according fabric 2.x ==============================
// ========================================================================================================
...
//     // let ordererOrgName = firstOrderer.orgId.name
